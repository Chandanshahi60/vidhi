                  ...
                  <div class="tab-content">
                                ...
                                @csrf
                                  <div class="card">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="title">Owner Name</label>
                                          <input class="form-control" id="owner_name" value="{{$post->owner_name}}" name="owner_name" type="text" aria-describedby="" placeholder="Enter Owner Name">
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                         ...
                                         <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <input class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10" value="{{$post->contact_no}}" id="contact_no" name="contact_no"  placeholder="Enter Contact Number">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="password">Password</label>
                                          <input class="form-control" id="password"  value="{{$post->password}}" name="password" type="text" aria-describedby="" placeholder="Enter Password">
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="present_address">Present Address</label>
                                          <textarea class="form-control" id="present_address" name="present_address" type="text" aria-describedby="" placeholder="Enter Society Address">{{$post->present_address}}</textarea>
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="permanent_address">Permanent Address</label>
                                          <textarea class="form-control" id="permanent_address" name="permanent_address" type="text" aria-describedby="" placeholder="Enter Society Address">{{$post->permanent_address}}</textarea>
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="aadhar">Aadhar Card</label>
                                          <input class="form-control"  value="{{$post->aadhar}}"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="12" id="aadhar" name="aadhar"  placeholder="Enter Aadhar Number">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="pan">Pan Card</label>
                                          <input class="form-control"  value="{{$post->pan}}"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="12" id="pan" name="pan"  placeholder="Enter Pan Number">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile"> Owner Photo</label>
                    ...
                    <div class="fade tab-pane" id="pills-delayed" role="tabpanel" aria-labelledby="pills-delayed-tab">
                      ...
                      <div class="card mb-0">
                        ...
                        <div class="card-header">
                          <h5 class="mb-0">Owner Members Details</h5>
                        </div>

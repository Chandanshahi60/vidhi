              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="owner_name">Name</label>
                      <input class="form-control" id="name" value="{{ (isset($post)?$post->name:'')}}" name="owner_name" type="text" aria-describedby="" placeholder="Enter Owner Name">
                    </div>
                    ...
                    <div class="row">
                    <label class="col-form-label pt-0" for="owner_unit0">Unit</label>
            ...
            <div class="row copiesrow${counter}">
                <div class="col-md-11" style="padding: 15px;">
                    <div class="row">
                        ...
                        {{-- <div class="col-md-5 pt-3">
                            <label class="form-label" for="owner_unit${counter}">Unit</label>

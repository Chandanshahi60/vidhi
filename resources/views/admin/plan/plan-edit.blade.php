              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" id="plan_name" name="plan_name" type="text" aria-describedby="" value="{{$post->plan_name}}" placeholder="Enter Name Of Plan">
                    </div>                  
                    
                    
                    <div class="mb-3">
                      <label class="col-form-label pt-0" for="duration_of_plan">Duration Of Plan</label>
                      <input class="form-control" id="duration_of_plan" name="duration_of_plan" type="text" value="{{$post->duration_of_plan}}" aria-describedby="" placeholder="Enter Duration Of Plan">
                    </div>  
                    
                    <div class="mb-3">
                      <label class="col-form-label pt-0" for="no_of_hostel">No. Of Hostel</label>
                      <input class="form-control" id="no_of_hostel" name="no_of_hostel" type="text" aria-describedby="" value="{{$post->no_of_hostel}}" placeholder="Enter No. Of Books">
                    </div>  
                    
                    <div class="mb-3">
                      <label class="col-form-label pt-0" for="price">Price Of Plan</label>
                      <input class="form-control" id="price" name="price" type="text" aria-describedby="" value="{{$post->price}}" placeholder="Enter Price">
                    </div>                 
                ...
                <div class="card-footer">
                  <button id="submitButton"  type="submit" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Saving..." data-rest-text="Update" class="btn btn-primary">Update</button>
                    <a  href= "{{route('plan-list')}}" class="btn btn-secondary">Cancel</a>
                </div>
              </div>
            </form>
            </div>

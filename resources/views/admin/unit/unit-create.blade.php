              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      {{-- <input class="form-control" id="floor_no" value="{{ (isset($post)?$post->floor_no:'')}}" name="floor_no" type="text" aria-describedby="" placeholder="Enter Floor No"> --}}
                    </div>

                     <div class="mb-3">
                      <label class="col-form-label pt-0" for="unit_no">Unit No:</label>
                      <input class="form-control" id="unit_no" value="{{ (isset($post)?$post->unit_no:'')}}" name="unit_no" type="text" aria-describedby="" placeholder="Enter Unit No">
                    </div>

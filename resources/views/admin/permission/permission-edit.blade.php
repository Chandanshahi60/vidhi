                ...
                <div class="card-body">
                    ...
                    <div class="col">
                      <div class="form-group m-t-15 m-checkbox-inline mb-0">
                        ...
                        {{-- @foreach($post->child_permission as $key=>$vals)
                          @php                             
                            $permissionname = explode(' ',$vals->name);
                          @endphp
                          <div class="checkbox checkbox-dark">
                            <input @if(in_array($vals->id,$rolePermissions)) checked @endif name="permissions[]" value="{{$permissionname[1]}}" id="permisssion-{{$vals->name}}"  class="permissioncheckbox" type="checkbox">
                            <label for="permisssion-{{$vals->name}}">{{ $permissionname[1] }}</label>
                          </div>
                        @endforeach --}}

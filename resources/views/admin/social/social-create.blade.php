              ...
              <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                      ...
                      <input class="form-control" value="{{ (isset($post)?$post->title:'')}}" id="title" name="title" type="text" aria-describedby="" placeholder="Enter Title">
                    </div>
                    
                    <div class="mb-3">
                      <label class="col-form-label pt-0" for="date">Date</label>
                      <input class="form-control" value="{{ (isset($post)?$post->date:'')}}" id="date" name="date" type="date" aria-describedby="" placeholder="Enter Date">
                    </div>

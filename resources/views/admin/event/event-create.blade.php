    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12 col-xl-6">
          <div class="row">
            <div class="col-sm-12">
                 <form id="submitForm"  method="post" enctype="multipart/form-data" action="{{$data['url']}}">
            {{csrf_field()}}
            <div class="row">

                <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
                    <label class="form-label">Title *</label>
                    <input value="{{ (isset($post)?$post->title:'')}}" class="form-control" name="title" id="title">
                </div>

                <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
                    <label class="form-label">Event Start Date *</label>
                    <input onblur="convertToSlug(this)" type="date"  value="{{ (isset($post)?$post->start_date:'')}}" class="form-control" name="start_date" id="start_date">
                </div>
                ...
                <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
                    ...
                    <input value="{{ (isset($post)?$post->venue:'')}}" class="form-control" name="venue" id="venue">
                </div>

                <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
                    <label class="form-label">Facebook Url</label>
                    <input value="{{ (isset($post)?$post->facebook_url:'')}}" class="form-control" name="facebook_url" id="facebook_url">
                </div>

                <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
                    <label class="form-label">Organiser</label>
                    <input value="{{ (isset($post)?$post->organiser:'')}}" class="form-control" name="organiser" id="organiser">
                </div>

                <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
                    <label class="form-label">City</label>
                    <input value="{{ (isset($post)?$post->city:'')}}" class="form-control" name="city" id="city">
                </div>


                <div class="form-group col-12">
                    <label   class="form-label"><b>Description</b></label>
                    <input class="form-control" value="{{ (isset($post)?$post->description:'')}}" type="text" name="description" id="description">
                </div>

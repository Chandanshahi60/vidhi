              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                      <label class="col-form-label pt-0" for="month">Bill Month</label>
                    ...
                    <div class="mb-3">
                        <label class="col-form-label pt-0" for="title">Maintenance Title</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="amount" value="{{ (isset($post)?$post->amount:'')}}" name="amount" type="text" aria-describedby="" placeholder="Enter amount">
                    </div>

                    <div class="mb-3">
                        <label class="col-form-label pt-0" for="details">Details</label>

            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="type">Notice Type</label>
                            <select class="form-select" id="type" name="type" >
                                <option value="">Select</option>
                                <option @if(isset($post)) @if($post->type=='tenant') selected @endif  @endif value="tenant">Tenant</option>
                                <option  @if(isset($post)) @if($post->type=='employee') selected @endif  @endif value="employee">Employee</option>
                                <option  @if(isset($post)) @if($post->type=='owner') selected @endif  @endif value="owner">Owner</option>

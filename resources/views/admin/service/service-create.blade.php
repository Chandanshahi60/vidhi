            ...
            <div class="col-sm-12">
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    {{-- <div class="mb-3">
                        <label class="col-form-label pt-0" for="name">Service Name</label>
                        <select class="form-select" id="name" name="name" >
                              <option value="">Select</option>
                              @foreach ($service_admin as $item)
                              <option @if(isset($post))  @if($post->name == $item->name) selected @endif @endif value="{{$item->name}}">{{$item->name}}</option>
                              @endforeach
                        </select>
                    </div> --}}
                        ...
                        <div class="copies-data">
                            <div class="row">
                                <div class="col-md-11" >
                                    <div class="row">
                                        <div class="col-md-11">
                                            <label class="col-form-label pt-0" for="services0">Services</label>
                                            <input class="form-control" id="name0" value="{{ (isset($post)?$post->services:'')}}" name="services[]" type="text" aria-describedby="" placeholder="Enter Services">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1" >
            ...
            <div class="row copiesrow${counter}">
                <div class="col-md-11" style="padding: 15px;">
                    <div class="row">
                        ...
                        <div class="col-md-11">
                            <label class="col-form-label pt-0" for="services${counter}">Services</label>
                            <input class="form-control" id="services${counter}" value="{{ (isset($post)?$post->services:'')}}" name="services[]" type="text" aria-describedby="" placeholder="Enter Services">
                        </div>
                    </div>
                </div>

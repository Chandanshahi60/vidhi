                      ...
                      <div class="table-responsive">
                        <table class="table table-hover">
                          <thead>
                            ...
                            <tr>
                              <th scope="col" width="200">Salary Month</th>
                              <th scope="col"  width="500">{{$employee->month}}</th>
                            </tr>

                            <tr>
                              <th scope="col" width="200">Salary Year</th>
                              <th scope="col"  width="500">{{$employee->year}}</th>
                            </tr>

                            <tr>
                              <th scope="col" width="200">Salary Per Month</th>
                              <th scope="col"  width="500">{{$employee->per_month}}</th>
                            </tr>

                            <tr>
                              <th scope="col" width="200">Issue Date</th>
                              <th scope="col"  width="500">{{$employee->issue_date}}</th>
                            </tr>

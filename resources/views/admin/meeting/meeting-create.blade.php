            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                        <label class="col-form-label pt-0" for="meeting_issue_date">Meeting Issue Date</label>
                        <input class="form-control" id="meeting_issue_date" value="{{ (isset($post)?$post->meeting_issue_date:'')}}" name="meeting_issue_date" type="date" aria-describedby="" placeholder="Enter Entry Date">
                        </div>
                        ...
                        <div class="mb-3">
                        <label class="col-form-label pt-0" for="meeting_desc">Meeting Description</label>

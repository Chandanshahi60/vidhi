              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="owner_name">Member Name</label>
                      <input class="form-control" id="name" value="{{ (isset($post)?$post->name:'')}}" name="owner_name" type="text" aria-describedby="" placeholder="Enter Member Name">
                    </div>

                    <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="username">Username</label>
                      <input class="form-control" id="username" value="{{ (isset($post)?$post->username:'')}}" name="username" type="text" aria-describedby="" placeholder="Enter Username">
                    </div>
                    ...
                    <div class="mb-3 col-md-3">
                     ...
                     <div class="mb-3 col-md-3">
                      ...
                      <input class="form-control" value="{{ (isset($post)?$post->mobile:'')}}" id="contact_no" name="contact_no" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10"type="number" aria-describedby="" placeholder="Enter contact no">
                    </div>

                    @if(isset($post)?$post->password:'')
                    @else
                    <div class="mb-3 col-md-3">
                    ...
                    <div class="mb-3 col-md-3">
                        ...
                        <input class="form-control" type="number"  value="{{isset ($post)?$post->flat_no:''}}"    id="flat_no" name="flat_no" placeholder="Enter Flat No">
                    </div>
                    ...
                    <!-- <div class="mb-3 col-md-3">
                        ...
                        <input class="form-control" value="{{ (isset($post)?$post->property_type:'')}}" type="text"  id="property_type" name="property_type"  placeholder="Enter Type of Property">
                    </div> -->
                    ...
                    <div class="mb-3 col-md-3">
                        ...
                        {{-- <input class="form-control" value="{{ (isset($post)?$post->gender:'')}}" id="gender" name="gender" type="text" aria-describedby="" placeholder="Enter gender"> --}}
                    ...
                    <div class="mb-3 text-align-left col-md-3">
                        ...
                        <select class="form-select " id="property_owned" name="property_owned" >
                            <option  @if(isset($post)) @if($post->property_owned==1) @endif  @endif value="1">Yes</option>
                            <option  @if(isset($post)) @if($post->property_owned==0) @endif  @endif value="0">No</option>
                        </select>
                    </div>
                    </div>

                    <div class="row">
                   {{-- <!-- <label class="col-form-label pt-0" for="owner_unit0">Member Unit</label>
                    ...
                    <div class="mb-3">
                      <label  class="col-form-label pt-0">Member Photo </label>
                                                    ...
                                                    <div class="col-md-10" style="padding: 15px;">
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 text-align-left col-md-3">
                                                                ...
                                                                <input class="form-control"  value="{{$vals->pan}}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="14" id="family_aadhar0" name="family_aadhar[]"  placeholder="Enter Aadhar Number">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="copies-data">
                                            <div class="row">
                                                @foreach($post->nominee_details as $key=>$vals)
                                                        ...
                                                        <div class="col-md-1" style="padding: 15px;">
                                                            <br />
                                                            <button class="btn mt-2 btn-danger " type="button" onclick="deleteNomineeData({{$vals->id}})"> <i class="fa fa-trash"></i> </button>
                                                        </div>
                                                    ...
                                                    <div class="col-md-10" style="padding: 15px;">
                                                        <div class="row">
                                                            ...
                                                            {{-- <div class="col-md-4 pt-3">
                                                                <label  class="col-form-label pt-0" for="vehicle_image0">Vehicle Image</label>

                                                                <div class="row">
                                                                    <div class="col-md-10 ">
                                                                        <input id="vehicle_image" type="file" class="form-control align-middle custom-file-input" name="vehicle_image[]" onchange="readURL(this, 'FileImg');">

                                                                        </div>
                                                                    <div class="col-md-2 ">
                                                                    <img id="FileImg" value="{{ (isset($post)?$post->vehicle_image:'')}}" src="{{url('/uploads/profile/default.png')}}"  style="width: 71px;height: 71px">
                                                                    </div>
                                                                </div>
                                                            </div> --}}
                                                        </div>
            ...
            <div class="row copiesrow${counter}">
                <div class="col-md-11" style="padding: 15px;">
                    <div class="row">
                        ...
                        {{-- <div class="col-md-5 pt-3">
                            <label class="form-label" for="owner_unit${counter}">Member Unit</label>
                ...
                <div class="col-md-11" style="padding: 15px;">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        {{-- <div class="col-md-4 pt-3">
                            <label  class="col-form-label pt-0" for="vehicle_image${counter}">Vehicle Image</label>

                            <div class="row">
                                <div class="col-md-10 ">
                                    <input id="vehicle_image${counter}" type="file" class="form-control align-middle custom-file-input" name="vehicle_image[]" onchange="readURL(this, 'FileImg');">
        ...
        function deleteParkingData(id){
            ...
            var con = confirm("Are You Sure Want to Delete This");
                ...
                if(con)
                {
                    ...
                    $.ajax({
                        dataType:'json',
                        url:"{{route('owner_parking-delete')}}",
                        type:'POST',
        ...
        function deleteNomineeData(id){
            ...
            var con = confirm("Are You Sure Want to Delete This");
                ...
                if(con)
                {
                    ...
                    $.ajax({
                        dataType:'json',
                        url:"{{route('owner_nominee-delete')}}",
                        type:'POST',
                        data:{'_token':"{{csrf_token()}}",'nominee_id':id},
                        success:function(d){
                            if(d.status){
                                successMsg('Message', d.msg, '');
                                setTimeout(function(){

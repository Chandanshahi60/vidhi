                        ...
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              ...
                              <th scope="col"  width="500">{{$complain->title}}</th>
                            </tr>

                            <tr>
                              <th scope="col" width="200">Description</th>
                              <th scope="col"  width="500">{{$complain->description}}</th>
                            </tr>

                            <tr>
                              <th scope="col" width="200">Date</th>
                              <th scope="col"  width="500">{{$complain->date}}</th>
                            </tr>

                            <tr>
                              <th scope="col" width="200">Status</th>
                              <th scope="col"  width="500">{!! ($complain->status=='1')?'<span class="badge badge-success"> Active </span>':'<span class="badge badge-danger"> INActive </span>' !!}</th>
                            </tr>

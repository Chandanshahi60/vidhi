            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                        <label class="col-form-label pt-0" for="gas_bill">Gas Bill Per Flat</label>
                        <input class="form-control" id="gas_bill" value="{{ (isset($post)?$post->gas_bill:'')}}" name="gas_bill" type="text" aria-describedby="">
                        </div>

                        <div class="mb-3">
                        <label class="col-form-label pt-0" for="security_bill">Security Bill Per Flat</label>
                        <input class="form-control" id="security_bill" value="{{ (isset($post)?$post->security_bill:'')}}" name="security_bill" type="text" aria-describedby="">
                        </div>

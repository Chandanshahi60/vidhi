                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="currency_name" value="{{ (isset($post)?$post->currency_name:'')}}" name="currency_name" type="text" aria-describedby="">
                        </div>

                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="symbol">Symbol</label>
                            <input class="form-control" id="symbol" value="{{ (isset($post)?$post->symbol:'')}}" name="symbol" type="text" aria-describedby="">
                        </div>

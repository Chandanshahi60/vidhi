            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="member_type">Member Type</label>
                            <input class="form-control" id="member_type" value="{{ (isset($post)?$post->member_type:'')}}" name="member_type" type="text" aria-describedby="">
                        </div>

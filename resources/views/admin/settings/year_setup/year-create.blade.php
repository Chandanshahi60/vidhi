            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="year_name">Year Name</label>
                            <input class="form-control" id="year_name" value="{{ (isset($post)?$post->year_name:'')}}" name="year_name" type="text" aria-describedby="">
                        </div>

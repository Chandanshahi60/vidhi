            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="month_name">Month Name</label>
                            <input class="form-control" id="month_name" value="{{ (isset($post)?$post->month_name:'')}}" name="month_name" type="text" aria-describedby="">
                        </div>

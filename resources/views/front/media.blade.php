                  ...
                  <div class="container">
                     <div class="row">
                        <div class="About">
                           ...
                           <span><i class="fa fa-angle-double-right" aria-hidden="true"></i>Media</span>
                        </div>
                     </div>
                  </div>
               </div>
               <html>
                  ...
                  <body>
                     <div class="container gallery-container">
                        <h1>Media</h1>
                        <p class="page-description text-center">Let’s look at a few examples of descriptions on gallery pages</p>

                        <div class="tz-gallery">
                           <div class="row">
                              <div class="col-sm-12 col-md-4">
                                 <a class="lightbox" href="javascript:void">
                                    <img src="{{asset('front/assets/images/resident1.jpg')}}">
                                 </a>
                              </div>
                              <div class="col-sm-6 col-md-4">
                                 <a class="lightbox" href="javascript:void">
                                    <img src="{{asset('front/assets/images/resident2.jpg')}}">
                                 </a>
                              </div>
                              <div class="col-sm-6 col-md-4">
                                 <a class="lightbox" href="javascript:void">
                                    <img src="{{asset('front/assets/images/resident3.jpg')}}">
                                 </a>
                              </div>

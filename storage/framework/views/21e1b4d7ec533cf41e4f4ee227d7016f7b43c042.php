              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input class="form-control" value="<?php echo e((isset($post)?$post->date:'')); ?>" id="date" name="date" type="date" aria-describedby="" placeholder="Enter Date">
                    </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aamoditsolutions/public_html/projects/society/resources/views/admin/social/social-create.blade.php ENDPATH**/ ?>
              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 col-md-3">
                      ...
                      <input class="form-control" id="username" value="<?php echo e((isset($post->user)?$post->user->username:'')); ?>" name="username" type="text" aria-describedby="" placeholder="Enter Username">
                    </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aamoditsolutions/public_html/projects/society/resources/views/admin/owner/owner-create.blade.php ENDPATH**/ ?>
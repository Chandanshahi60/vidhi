            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input class="form-control" id="in_time" value="<?php echo e((isset($post)?$post->in_time:'')); ?>" name="in_time" type="text" aria-describedby="" placeholder="Enter in_time">
                        </div>

                        <div class="mb-3">
                        <label class="col-form-label pt-0" for="out_time">Out Time</label>
                        <input class="form-control" id="out_time" value="<?php echo e((isset($post)?$post->out_time:'')); ?>" name="out_time" type="text" aria-describedby="" placeholder="Enter out_time">
                        </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\society\resources\views/admin/visitors/visitors-create.blade.php ENDPATH**/ ?>
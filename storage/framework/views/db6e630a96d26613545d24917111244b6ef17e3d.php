            ...
            <div class="col-sm-12">
              ...
              <div class="card">
                <div class="card-body">
                     ...
                     <div class="mb-3">
                      <label class="col-form-label pt-0" for="unique_id">Unique Id</label>
                      <input class="form-control" id="unique_id" value="<?php echo e((isset($post)?$post->unique_id:'')); ?>" name="unique_id" type="text" aria-describedby="" placeholder="Enter Name">
                    </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aamoditsolutions/public_html/projects/society/resources/views/admin/users/user-create.blade.php ENDPATH**/ ?>
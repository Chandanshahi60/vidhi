              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 col-md-3">
                      ...
                      <input class="form-control" id="name" value="<?php echo e((isset($post)?$post->name:'')); ?>" name="owner_name" type="text" aria-describedby="" placeholder="Enter Member Name">
                    </div>

                    <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="username">Username</label>
                      <input class="form-control" id="username" value="<?php echo e((isset($post)?$post->username:'')); ?>" name="username" type="text" aria-describedby="" placeholder="Enter Username">
                    </div>

                    <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="email">Email</label>
                      <input class="form-control" id="email" value="<?php echo e((isset($post)?$post->email:'')); ?>" name="email" type="text" aria-describedby="" placeholder="Enter Email">
                    </div>

                     <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="contact_no">Contact No</label>
                      <input class="form-control" value="<?php echo e((isset($post)?$post->mobile:'')); ?>" id="contact_no" name="contact_no" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10"type="number" aria-describedby="" placeholder="Enter contact no">
                    </div>

                    <?php if(isset($post)?$post->password:''): ?>
                    <?php else: ?>
                    <div class="mb-3 col-md-3">
                      <label class="col-form-label pt-0" for="password">Password</label>
                      <input class="form-control" value="<?php echo e((isset($post)?$post->password:'')); ?>" id="password" name="password" type="password" aria-describedby="" placeholder="Enter password">
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\society\resources\views/admin/owner/owner-create.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>" type="email" id="email" name="email" required="required" placeholder="admin@gmail.com">
              ...
              <div class="form-group">
               ...
               <div class="form-group society" style="display:none">
                <label class="col-form-label pt-0" for="society">Socity List</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\society\resources\views/auth/login.blade.php ENDPATH**/ ?>
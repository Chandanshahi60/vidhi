                    ...
                    <div class="email-app-sidebar left-bookmark">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <h6 class="f-w-600"><?php echo e($post->society_name); ?></h6>
                          <p><?php echo e($post->email); ?></p>
                        </div>
                      </div>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="pills-created" role="tabpanel" aria-labelledby="pills-created-tab">
                      <div class="card mb-0">
                        ...
                        <div class="card-body p-0">
                              <form enctype="multipart/form-data" class="theme-form" id="BasicsubmitForm" action="<?php echo e($data['url']); ?>">
                                <?php echo csrf_field(); ?>
                                  <div class="card">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <input class="form-control" id="society_name" value="<?php echo e($post->society_name); ?>" name="society_name" type="text" aria-describedby="" placeholder="Enter Society Name">
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="title">State</label>
                                            <select class="form-select select2" id="state" name="state" onchange="getCities()">
                                                ...
                                                <?php $__currentLoopData = states(101); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$vals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <label class="col-form-label  text-align-left pt-0" for="title">City</label>
                                            <select class="form-select select2" id="city" name="city" >
                                              <option value="">Select City</option>
                                                <?php $__currentLoopData = cities($post->state); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$vals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <textarea class="form-control" id="society_address" name="society_address" type="text" aria-describedby="" placeholder="Enter Society Address"><?php echo e($post->society_address); ?></textarea>
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="email">Email</label>
                                          <input class="form-control" id="email"  value="<?php echo e($post->email); ?>" name="email" type="text" aria-describedby="" placeholder="Enter Email">
                                        </div>


                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Pincode</label>
                                          <input class="form-control"  value="<?php echo e($post->pincode); ?>"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="6" id="pincode" name="pincode"  placeholder="Enter Pincode Number">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile"> Society Unique ID</label>
                                          <input class="form-control"  value="<?php echo e($post->society_unique_id); ?>"  type="text"  id="society_unique_id" name="society_unique_id" placeholder="Enter Society Unique ID">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Total Flats</label>
                                          <input class="form-control" type="number"   value="<?php echo e($post->total_flats); ?>"  id="total_flats" name="total_flats" placeholder="Enter Total Flats">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Emergency Contact No</label>
                                          <input class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10" value="<?php echo e($post->emergency_contact_no); ?>" id="emergency_contact_no" name="emergency_contact_no"  placeholder="Enter Contact Number">
                                        </div>


                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">RWA Registration No</label>
                                          <input class="form-control" type="text"  id="rwa_registration" name="rwa_registration" value="<?php echo e($post->rwa_registration); ?>"  placeholder="Enter Registration Number">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Registration date</label>
                                          <input class="form-control" type="date"  id="registration_date" name="registration_date"  value="<?php echo e($post->registration_date); ?>"   placeholder="Enter Registration Date">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Last Election date</label>
                                          <input class="form-control" type="date"  id="last_election_held" name="last_election_held"  value="<?php echo e($post->last_election_held); ?>"   placeholder="Enter Last Election Date">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Last Election Due date</label>
                                          <input class="form-control" type="date"  id="election_due_date" name="election_due_date"  value="<?php echo e($post->election_due_date); ?>"  placeholder="Enter Election Due Date">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">Last Audit</label>
                                          <input class="form-control" type="date"  id="last_audit" name="last_audit"  value="<?php echo e($post->last_audit); ?>"  placeholder="Enter Last Audit">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">No of Families</label>
                                          <input class="form-control" type="number"  id="no_of_families" name="no_of_families"   value="<?php echo e($post->no_of_families); ?>"   placeholder="Enter No Of Families">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="mobile">No Of Gates</label>
                                          <input class="form-control" type="number"  id="no_of_gates" name="no_of_gates"   value="<?php echo e($post->no_of_gates); ?>"   placeholder="Enter No Of Gates">
                                        </div>
                    ...
                    <div class="fade tab-pane" id="pills-delayed" role="tabpanel" aria-labelledby="pills-delayed-tab">
                      ...
                      <div class="card mb-0">
                        ...
                        <div class="card-body p-0">
                              <form enctype="multipart/form-data" class="theme-form" id="SocietyForm" action="<?php echo e(route('society-member-update',$post->id)); ?>">
                                <?php echo csrf_field(); ?>
                                  <div class="card">
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <input   class="form-control"   value="<?php echo e(($post->society_members_details)?$post->society_members_details->full_name:''); ?>"  id="full_name" name="full_name" type="text"  aria-describedby="" placeholder="Enter Full Name">
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <input class="form-control" type="number"  value="<?php echo e(($post->society_members_details)?$post->society_members_details->flat_no:''); ?>"   id="flat_no" name="flat_no" placeholder="Enter Flat No">
                                        </div>

                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="contact_no">Contact No</label>
                                          <input class="form-control" value="<?php echo e(($post->society_members_details)?$post->society_members_details->contact_no:''); ?>"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10" id="contact_no" name="contact_no"  placeholder="Enter Contact Number">
                                        </div>


                                        <div class="mb-3 text-align-left col-md-4">
                                          <label class="col-form-label  text-align-left pt-0" for="property_type">Type of Property</label>
                                          <input class="form-control" value="<?php echo e(($post->society_members_details)?$post->society_members_details->property_type:''); ?>" type="text"  id="property_type" name="property_type"  placeholder="Enter Type of Property">
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <select class="form-select " id="property_owned" name="property_owned" >
                                              <option <?php if($post->society_members_details): ?> <?php if($post->society_members_details->property_owned==1): ?> selected <?php endif; ?> <?php endif; ?> value="1">Yes</option>
                                              <option <?php if($post->society_members_details): ?> <?php if($post->society_members_details->property_owned==0): ?> selected <?php endif; ?> <?php endif; ?>  value="0">No</option>
                                          </select>
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <textarea class="form-control" id="address" name="address" type="text" aria-describedby="" placeholder="Enter Society Address"><?php echo e(($post->society_members_details)?$post->society_members_details->address:''); ?></textarea>
                                        </div>

                                        <div class="property_owner_div row"  <?php if($post->society_members_details): ?> <?php if($post->society_members_details->property_owned==1): ?> style="display: none" <?php endif; ?> <?php endif; ?> >

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="property_owner_name">Owner Name</label>
                                              <input class="form-control"  value="<?php echo e(($post->society_members_details)?$post->society_members_details->property_owner_name:''); ?>" id="property_owner_name" name="property_owner_name" type="text" aria-describedby="" placeholder="Enter Property Owner Name">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="contact_no">Owner Contact No</label>
                                              <input class="form-control" value="<?php echo e(($post->society_members_details)?$post->society_members_details->owner_contact_no:''); ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10" id="owner_contact_no" name="owner_contact_no"  placeholder="Enter Contact Number">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="address">Owner Address</label>
                                              <textarea class="form-control" id="owner_address" name="owner_address" type="text" aria-describedby="" placeholder="Enter Owner Address"><?php echo e(($post->society_members_details)?$post->society_members_details->owner_address:''); ?></textarea>
                                            </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <select class="form-select " onchange="toggleFunctionality('is_committee_member','is_committee_member_data')" id="is_committee_member" name="is_committee_member" >
                                              ...
                                              <option <?php if(isset($post)): ?> <?php if($post->is_committee_member==1): ?> selected <?php endif; ?>  <?php endif; ?> value="1">Yes</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_committee_member==0): ?> selected <?php endif; ?>  <?php endif; ?>  value="0">No</option>
                                          </select>
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <select class="form-select " onchange="toggleFunctionality('is_add_family_members','memberdetails')" id="is_add_family_members" name="is_add_family_members" >
                                              <option value="">Select</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_add_family_members==1): ?> selected <?php endif; ?>  <?php endif; ?> value="1">Yes</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_add_family_members==0): ?> selected <?php endif; ?>  <?php endif; ?> value="0">No</option>
                                          </select>
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <select class="form-select " onchange="toggleFunctionality('is_vehicle','is_vehicle_data')" id="is_vehicle" name="is_vehicle" >
                                              <option value="">Select</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_vehicle==1): ?> selected <?php endif; ?>  <?php endif; ?> value="1">Yes</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_vehicle==0): ?> selected <?php endif; ?>  <?php endif; ?> value="0">No</option>
                                          </select>
                                        </div>
                                        ...
                                        <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <select class="form-select " onchange="toggleFunctionality('is_staff_members','is_staff_members_data')" id="is_staff_members" name="is_staff_members" >
                                              <option value="">Select</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_staff_members==1): ?> selected <?php endif; ?>  <?php endif; ?>  value="1">Yes</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_staff_members==0): ?> selected <?php endif; ?>  <?php endif; ?> value="0">No</option>
                                          </select>
                                        </div>
                                         ...
                                         <div class="mb-3 text-align-left col-md-4">
                                          ...
                                          <select class="form-select " onchange="toggleFunctionality('is_nominee','nomineedetails')" id="is_nominee" name="is_nominee" >
                                              <option value="">Select</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_nominee==1): ?> selected <?php endif; ?>  <?php endif; ?> value="1">Yes</option>
                                              <option <?php if(isset($post)): ?> <?php if($post->is_nominee==0): ?> selected <?php endif; ?>  <?php endif; ?> value="0">No</option>
                                          </select>
                                        </div>
                                        ...
                                        <div id="is_committee_member_data" class="row" style="display: none;">
                                            ...
                                            <div class="mb-3 text-align-left col-md-4">
                                              ...
                                              <input class="form-control" value="<?php echo e(($post->committe_details)?$post->committe_details->name:''); ?>" id="name" name="name" type="text" aria-describedby="" placeholder="Enter Committe Name">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="mobile"> Designation</label>
                                              <input class="form-control" value="<?php echo e(($post->committe_details)?$post->committe_details->designation:''); ?>"  type="text"  id="designation" name="designation" placeholder="Enter Designation">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="mobile">Contact No</label>
                                              <input class="form-control" value="<?php echo e(($post->committe_details)?$post->committe_details->contact_no:''); ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="10" id="contact_no" name="contact_no"  placeholder="Enter Contact Number">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="mobile">From date</label>
                                              <input class="form-control" value="<?php echo e(($post->committe_details)?$post->committe_details->from_date:''); ?>" type="date"  id="from_date" name="from_date"  placeholder="Enter From Date">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="mobile">Till date</label>
                                              <input class="form-control"  value="<?php echo e(($post->committe_details)?$post->committe_details->till_date:''); ?>"  type="date"  id="till_date" name="till_date"  placeholder="Enter Till date">
                                            </div>

                                            <div class="mb-3 text-align-left col-md-4">
                                              <label class="col-form-label  text-align-left pt-0" for="email">Address</label>
                                              <textarea class="form-control" id="address" name="address" type="text" aria-describedby="" placeholder="Enter Society Address"><?php echo e(($post->committe_details)?$post->committe_details->address:''); ?></textarea>
                                            </div>
                                         ...
                                         <div id="memberdetails" style="display: none">
                                            ...
                                            <?php if($post->society_members_details): ?>
                                              <?php if($post->society_members_details->family_details->count() > 0): ?>

                                                <?php $__currentLoopData = $post->society_members_details->family_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$vals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      ...
                                                      <div  class="col-md-10">
                                                        <div class="row row-padding" >
                                                            ...
                                                            <div class="mb-3 text-align-left col-md-3">
                                                              ...
                                                              <input class="form-control" value="<?php echo e($vals->family_occupation); ?>" id="family_occupation0"  name="family_occupation[]"  type="text" aria-describedby="" placeholder="Enter Occupation">
                                                            </div>
                                                        </div>
                                                      </div>
                                                      </div>
                                         ...
                                         <div id="nomineedetails" style="display: none">
                                          ...
                                          <?php if($post->society_members_details): ?>
                                                <?php $__currentLoopData = $post->society_members_details->nominee_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$vals): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      ...
                                                      <div  class="col-md-10">
                                                        <div class="row row-padding" >
                                                            <div class="col-md-12">
                                                                ...
                                                                <input class="form-control" id="name0" value="<?php echo e((isset($vals)?$vals->nominator_name:'')); ?>" name="nominator_name[]" type="text" aria-describedby="" placeholder="Enter Nominator Name">
                                                            </div>

                                                            <div class="col-md-12  pt-3">
                                                                <label class="col-form-label pt-0" for="nominated_name0">Nominated Person Name</label>
                                                                <input class="form-control" id="name0" value="<?php echo e((isset($vals)?$vals->nominated_name:'')); ?>" name="nominated_name[]" type="text" aria-describedby="" placeholder="Enter Nominated Person Name">
                                                            </div>

                                                            <div class="col-md-12 pt-3">
                                                                <label class="col-form-label pt-0" for="percentage0">Percentage</label>
                                                                <input class="form-control" id="name0" value="<?php echo e((isset($vals)?$vals->percentage:'')); ?>" name="percentage[]" type="text" aria-describedby="" placeholder="Enter Percentage">
                                                            </div>
                                                        </div>
                                                      </div>
                                                      </div>
                                        ...
                                        <div id="is_vehicle_data" class="row" style="display: none;">
                                          ...
                                          <div class="mb-3 text-align-left col-md-4">
                                            ...
                                            <input   class="form-control"   value="<?php echo e(($post->parking_details)?$post->parking_details->owner_name:''); ?>"  id="owner_name" name="owner_name" type="text"  aria-describedby="" placeholder="Enter Full Name">
                                          </div>
                                          ...
                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="flat_no"> Flat No</label>
                                            <input class="form-control" type="number"  value="<?php echo e(($post->parking_details)?$post->parking_details->flat_no:''); ?>"   id="flat_no" name="flat_no" placeholder="Enter Flat No">
                                          </div>

                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="vehicle_type">Vehicle Type</label>
                                            <input class="form-control" value="<?php echo e(($post->parking_details)?$post->parking_details->vehicle_type:''); ?>"  type="text"  id="vehicle_type" name="vehicle_type"  placeholder="Enter Vehicle Type">
                                          </div>


                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="rc_number">RC No</label>
                                            <input class="form-control" value="<?php echo e(($post->parking_details)?$post->parking_details->rc_number:''); ?>" type="text"  id="rc_number" name="rc_number"  placeholder="Enter RC Number">
                                          </div>
                                          ...
                                          <div class="mb-3 text-align-left col-md-4">
                                            ...
                                            <select class="form-select " id="is_insured" name="is_insured" >
                                                <option  <?php if($post->parking_details): ?> <?php if($post->parking_details->is_insured=='Yes'): ?> selected <?php endif; ?> <?php endif; ?> value="Yes">Yes</option>
                                                <option  <?php if($post->parking_details): ?> <?php if($post->parking_details->is_insured=='No'): ?> selected <?php endif; ?> <?php endif; ?>  value="No">No</option>
                                            </select>
                                          </div>

                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="parking_no">Parking No</label>
                                            <input class="form-control" value="<?php echo e(($post->parking_details)?$post->parking_details->parking_no:''); ?>" type="text"  id="parking_no" name="parking_no"  placeholder="Enter Parking No">
                                          </div>
                                        ...
                                        <div id="is_staff_members_data" class="row" style="display: none;">
                                          ...
                                          <div class="mb-3 text-align-left col-md-4">
                                            ...
                                            <input   class="form-control"   value="<?php echo e(($post->workers)?$post->workers->name:''); ?>"  id="name" name="name" type="text"  aria-describedby="" placeholder="Enter Full Name">
                                          </div>

                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="f_name"> Father Name</label>
                                            <input class="form-control" type="text"  value="<?php echo e(($post->workers)?$post->workers->f_name:''); ?>"   id="f_name" name="f_name" placeholder="Enter Father Name">
                                          </div>
                                          ...
                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="address">Address</label>
                                            <textarea class="form-control" id="address" name="address"  aria-describedby="" placeholder="Enter Address"><?php echo e(($post->workers)?$post->workers->address:''); ?></textarea>
                                          </div>

                                          <div class="mb-3 text-align-left col-md-4">
                                            <label class="col-form-label  text-align-left pt-0" for="permanent_address">Permanent Address</label>
                                            <textarea class="form-control" id="permanent_address" name="permanent_address"  aria-describedby="" placeholder="Enter Permanent Address"><?php echo e(($post->workers)?$post->workers->permanent_address:''); ?></textarea>
                                          </div>
                                          ...
                                          <div class="mb-3 text-align-left col-md-4">
                                            ...
                                            <input class="form-control"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="12" value="<?php echo e(($post->workers)?$post->workers->aadhar_card:''); ?>"  type="text"  id="aadhar_card" name="aadhar_card"  placeholder="Enter Aadhar Card">
                                          </div>
                    ...
                    <div class="fade tab-pane" id="pills-upcoming" role="tabpanel" aria-labelledby="pills-upcoming-tab">
                        <div class="card mb-0">
                          ...
                          <form enctype="multipart/form-data" class="theme-form" id="SocietyParkingForm" action="<?php echo e(route('society-parking-update',$post->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                    ...
                    <div class="fade tab-pane" id="pills-weekly" role="tabpanel" aria-labelledby="pills-weekly-tab">
                      <div class="card mb-0">
                        ...
                        <form enctype="multipart/form-data" class="theme-form" id="WorkersParkingForm" action="<?php echo e(route('society-workers-update',$post->id)); ?>">
                          <?php echo csrf_field(); ?>
                          <div class="card-body">
                                <div class=" row text-center">
                    ...
                    <div class="fade tab-pane" id="pills-monthly" role="tabpanel" aria-labelledby="pills-monthly-tab">
                      <div class="card mb-0">
                        ...
                        <form enctype="multipart/form-data" class="theme-form" id="SecurityForm" action="<?php echo e(route('society-security-update',$post->id)); ?>">
                          <?php echo csrf_field(); ?>
                          <div class="card-body">
                                <div class=" row text-center">
                                    <h6>Security Form</h6>
                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="owner_name">Name</label>
                                    <input   class="form-control"   value="<?php echo e(($post->security)?$post->security->name:''); ?>"  id="name" name="name" type="text"  aria-describedby="" placeholder="Enter Full Name">
                                  </div>

                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="f_name"> Father Name</label>
                                    <input class="form-control" type="text"  value="<?php echo e(($post->security)?$post->security->fathers_name:''); ?>"   id="fathers_name" name="fathers_name" placeholder="Enter Father Name">
                                  </div>

                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="dob"> DOB </label>
                                    <input class="form-control" type="date"  value="<?php echo e(($post->security)?$post->security->dob:''); ?>"   id="dob" name="dob" placeholder="Enter DOB">
                                  </div>

                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="education"> Education </label>
                                    <input class="form-control" type="text"  value="<?php echo e(($post->security)?$post->security->education:''); ?>"   id="education" name="education" placeholder="Enter Education">
                                  </div>

                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="address">Address</label>
                                    <textarea class="form-control" id="address" name="address"  aria-describedby="" placeholder="Enter Address"><?php echo e(($post->security)?$post->security->address:''); ?></textarea>
                                  </div>

                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="permanent_address">Permanent Address</label>
                                    <textarea class="form-control" id="permanent_address" name="permanent_address"  aria-describedby="" placeholder="Enter Permanent Address"><?php echo e(($post->security)?$post->security->permanent_address:''); ?></textarea>
                                  </div>

                                  <div class="mb-3 text-align-left col-md-4">
                                    <label class="col-form-label  text-align-left pt-0" for="aadhar_card">Aadhar Card</label>
                                    <input class="form-control"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type="number" maxlength="12" value="<?php echo e(($post->security)?$post->workers->aadhar_card:''); ?>"  type="text"  id="aadhar_card" name="aadhar_card"  placeholder="Enter Aadhar Card">
                                  </div>
                                  ...
                                  <div class="mb-3 text-align-left col-md-3">
                                    ...
                                    <select class="form-select " id="is_security_agency" name="is_security_agency" >
                                        <option value="">Select</option>
                                        <option <?php if($post->security): ?> <?php if($post->security->is_security_agency==1): ?> selected <?php endif; ?> <?php endif; ?>  value="1">Yes</option>
                                        <option <?php if($post->security): ?> <?php if($post->security->is_security_agency==0): ?> selected <?php endif; ?> <?php endif; ?> value="0">No</option>
                                    </select>
                                  </div>

                                  <div class="is_security_agency_div row"  <?php if($post->security): ?> <?php if($post->security->is_security_agency==0): ?> style="display: none"  <?php endif; ?> <?php else: ?> style="display: none"  <?php endif; ?> >

                                    <div class="mb-3 text-align-left col-md-4">
                                      <label class="col-form-label  text-align-left pt-0" for="agency_name">Agency Name</label>
                                      <input class="form-control"  value="<?php echo e(($post->security)?$post->security->agency_name:''); ?>" id="agency_name" name="agency_name" type="text" aria-describedby="" placeholder="Enter Agency Name">
                                    </div>


                                    <div class="mb-3 text-align-left col-md-4">
                                      <label class="col-form-label  text-align-left pt-0" for="agency_city">Agency City</label>
                                      <input class="form-control"  value="<?php echo e(($post->security)?$post->security->agency_city:''); ?>" id="agency_city" name="agency_city" type="text" aria-describedby="" placeholder="Enter City Name">
                                    </div>

                                    <div class="mb-3 text-align-left col-md-4">
                                      <label class="col-form-label  text-align-left pt-0" for="licence">licence</label>
                                      <input class="form-control"  value="<?php echo e(($post->security)?$post->security->licence:''); ?>" id="licence" name="licence" type="text" aria-describedby="" placeholder="Enter Licence">
                                    </div>

                                    <div class="mb-3 text-align-left col-md-4">
                                      <label class="col-form-label  text-align-left pt-0" for="address">Agency Address</label>
                                      <textarea class="form-control" id="agency_address" name="agency_address" type="text" aria-describedby="" placeholder="Enter Agency Address"><?php echo e(($post->security)?$post->security->agency_address:''); ?></textarea>
                                    </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\society\resources\views/admin/society/society-edit.blade.php ENDPATH**/ ?>
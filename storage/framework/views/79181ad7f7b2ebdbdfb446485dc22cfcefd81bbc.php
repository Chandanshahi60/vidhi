            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="country_name">Country Name</label>
                            <input class="form-control" id="country_name" value="<?php echo e((isset($post)?$post->country_name:'')); ?>" name="country_name" type="text" aria-describedby="">
                        </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\society\resources\views/admin/settings/country/country-create.blade.php ENDPATH**/ ?>
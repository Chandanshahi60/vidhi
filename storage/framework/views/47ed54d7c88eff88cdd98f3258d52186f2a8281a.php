            ...
            <div class="row">
               ...
               <div class=" col-md-12 col-lg-12 col-xl-12">
                  <div class="row">
                     ...
                     <div class="col-sm-12 col-lg-4 col-md-4 ">
                        <a href="<?php echo e(route('banner-list')); ?>"> <div class="card">
                           <div class="card-body" >
                              ...
                              <div style="display:flex;align-items:center">
                                 <img style="height:50px;width:50px" src="<?php echo e(asset('admin/assets/images/banner.png')); ?>">
                      ...
                      <div class="col-sm-12 col-lg-4 col-md-4 ">
                        <a href="<?php echo e(route('plan-list')); ?>"> <div class="card">
                           <div class="card-body" >
                              ...
                              <div style="display:flex;align-items:center">
                                 <img style="height:50px;width:50px" src="<?php echo e(asset('admin/assets/images/membership.png')); ?>">
                     ...
                     <div class="col-sm-12 col-lg-4 col-md-4 ">
                        <a href="<?php echo e(route('event-list')); ?>"> <div class="card">
                           <div class="card-body" >
                              <h4 class="mb-1" style="font-weight: 600;font-size: 16px;">Event</h4>
                              <div style="display:flex;align-items:center">
                                 <img style="height:50px;width:50px" src="<?php echo e(asset('admin/assets/images/event.jpg')); ?>">
                                 <h2 class="mb-1 number-font" style="padding-left: 15px"><?php echo e($employee); ?></h2>
                              </div>
                           </div>
                        </div></a>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\society\resources\views/admin/welcome.blade.php ENDPATH**/ ?>
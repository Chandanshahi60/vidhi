            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="currency_name">Currency Name</label>
                            <input class="form-control" id="currency_name" value="<?php echo e((isset($post)?$post->currency_name:'')); ?>" name="currency_name" type="text" aria-describedby="">
                        </div>

                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="symbol">Symbol</label>
                            <input class="form-control" id="symbol" value="<?php echo e((isset($post)?$post->symbol:'')); ?>" name="symbol" type="text" aria-describedby="">
                        </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\society\resources\views/admin/settings/currency/currency-create.blade.php ENDPATH**/ ?>
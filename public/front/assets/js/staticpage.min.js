...
/*! Copyright (c) 2013 Brandon Aaron (http://brandon.aaron.sh)
     ...
     */
;!function(a){"function"==typeof define&&define.amd?define(["jquery"],a):"object"==typeof exports?module.exports=a:a(jQuery)}(function(a){function b(b){var g=b||window.event,h=i.call(arguments,1),j=0,l=0,m=0,n=0,o=0,p=0;if(b=a.event.fix(g),b.type="mousewheel","detail" in g&&(m=-1*g.detail),"wheelDelta" in g&&(m=g.wheelDelta),"wheelDeltaY" in g&&(m=g.wheelDeltaY),"wheelDeltaX" in g&&(l=-1*g.wheelDeltaX),"axis" in g&&g.axis===g.HORIZONTAL_AXIS&&(l=-1*m,m=0),j=0===m?l:m,"deltaY" in g&&(m=-1*g.deltaY,j=m),"deltaX" in g&&(l=g.deltaX,0===m&&(j=-1*l)),0!==m||0!==l){if(1===g.deltaMode){var q=a.data(this,"mousewheel-line-height");j*=q,m*=q,l*=q}else{if(2===g.deltaMode){var r=a.data(this,"mousewheel-page-height");j*=r,m*=r,l*=r}}if(n=Math.max(Math.abs(m),Math.abs(l)),(!f||f>n)&&(f=n,d(g,n)&&(f/=40)),d(g,n)&&(j/=40,l/=40,m/=40),j=Math[j>=1?"floor":"ceil"](j/f),l=Math[l>=1?"floor":"ceil"](l/f),m=Math[m>=1?"floor":"ceil"](m/f),k.settings.normalizeOffset&&this.getBoundingClientRect){var s=this.getBoundingClientRect();o=b.clientX-s.left,p=b.clientY-s.top}return b.deltaX=l,b.deltaY=m,b.deltaFactor=f,b.offsetX=o,b.offsetY=p,b.deltaMode=0,h.unshift(b,j,l,m),e&&clearTimeout(e),e=setTimeout(c,200),(a.event.dispatch||a.event.handle).apply(this,h)}}function c(){f=null}function d(a,b){return k.settings.adjustOldDeltas&&"mousewheel"===a.type&&b%120===0}var e,f,g=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],h="onwheel" in document||document.documentMode>=9?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],i=Array.prototype.slice;if(a.event.fixHooks){for(var j=g.length;j;){a.event.fixHooks[g[--j]]=a.event.mouseHooks}}var k=a.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener){for(var c=h.length;c;){this.addEventListener(h[--c],b,!1)}}else{this.onmousewheel=b}a.data(this,"mousewheel-line-height",k.getLineHeight(this)),a.data(this,"mousewheel-page-height",k.getPageHeight(this))},teardown:function(){if(this.removeEventListener){for(var c=h.length;c;){this.removeEventListener(h[--c],b,!1)}}else{this.onmousewheel=null}a.removeData(this,"mousewheel-line-height"),a.removeData(this,"mousewheel-page-height")},getLineHeight:function(b){var c=a(b),d=c["offsetParent" in a.fn?"offsetParent":"parent"]();return d.length||(d=a("body")),parseInt(d.css("fontSize"),10)||parseInt(c.css("fontSize"),10)||16},getPageHeight:function(b){return a(b).height()},settings:{adjustOldDeltas:!0,normalizeOffset:!0}};a.fn.extend({mousewheel:function(a){return a?this.bind("mousewheel",a):this.trigger("mousewheel")},unmousewheel:function(a){return this.unbind("mousewheel",a)}})});Date.parseFunctions={count:0};Date.parseRegexes=[];Date.formatFunctions={count:0};Date.prototype.dateFormat=function(b){if(b=="unixtime"){return parseInt(this.getTime()/1000)}if(Date.formatFunctions[b]==null){Date.createNewFormat(b)}var a=Date.formatFunctions[b];return this[a]()};Date.createNewFormat=function(format){var funcName="format"+Date.formatFunctions.count++;Date.formatFunctions[format]=funcName;var codePrefix="Date.prototype."+funcName+" = function() {return ";var code="";var special=false;var ch="";for(var i=0;i<format.length;++i){ch=format.charAt(i);if(!special&&ch=="\\"){special=true}else{if(special){special=false;code+="'"+String.escape(ch)+"' + "}else{code+=Date.getFormatCode(ch)}}}if(code.length==0){code='""'}else{code=code.substring(0,code.length-3)}eval(codePrefix+code+";}")};Date.getFormatCode=function(a){switch(a){case"d":return"String.leftPad(this.getDate(), 2, '0') + ";case"D":return"Date.dayNames[this.getDay()].substring(0, 3) + ";case"j":return"this.getDate() + ";case"l":return"Date.dayNames[this.getDay()] + ";case"S":return"this.getSuffix() + ";case"w":return"this.getDay() + ";case"z":return"this.getDayOfYear() + ";case"W":return"this.getWeekOfYear() + ";case"F":return"Date.monthNames[this.getMonth()] + ";case"m":return"String.leftPad(this.getMonth() + 1, 2, '0') + ";case"M":return"Date.monthNames[this.getMonth()].substring(0, 3) + ";case"n":return"(this.getMonth() + 1) + ";case"t":return"this.getDaysInMonth() + ";case"L":return"(this.isLeapYear() ? 1 : 0) + ";case"Y":return"this.getFullYear() + ";case"y":return"('' + this.getFullYear()).substring(2, 4) + ";case"a":return"(this.getHours() < 12 ? 'am' : 'pm') + ";case"A":return"(this.getHours() < 12 ? 'AM' : 'PM') + ";case"g":return"((this.getHours() %12) ? this.getHours() % 12 : 12) + ";case"G":return"this.getHours() + ";case"h":return"String.leftPad((this.getHours() %12) ? this.getHours() % 12 : 12, 2, '0') + ";case"H":return"String.leftPad(this.getHours(), 2, '0') + ";case"i":return"String.leftPad(this.getMinutes(), 2, '0') + ";case"s":return"String.leftPad(this.getSeconds(), 2, '0') + ";case"O":return"this.getGMTOffset() + ";case"T":return"this.getTimezone() + ";case"Z":return"(this.getTimezoneOffset() * -60) + ";default:return"'"+String.escape(a)+"' + "}};Date.parseDate=function(a,c){if(c=="unixtime"){return new Date(!isNaN(parseInt(a))?parseInt(a)*1000:0)}if(Date.parseFunctions[c]==null){Date.createParser(c)}var b=Date.parseFunctions[c];return Date[b](a)};Date.createParser=function(format){var funcName="parse"+Date.parseFunctions.count++;var regexNum=Date.parseRegexes.length;var currentGroup=1;Date.parseFunctions[format]=funcName;var code="Date."+funcName+" = function(input) {\nvar y = -1, m = -1, d = -1, h = -1, i = -1, s = -1, z = -1;\nvar d = new Date();\ny = d.getFullYear();\nm = d.getMonth();\nd = d.getDate();\nvar results = input.match(Date.parseRegexes["+regexNum+"]);\nif (results && results.length > 0) {";var regex="";var special=false;var ch="";for(var i=0;i<format.length;++i){ch=format.charAt(i);if(!special&&ch=="\\"){special=true}else{if(special){special=false;regex+=String.escape(ch)}else{obj=Date.formatCodeToRegex(ch,currentGroup);currentGroup+=obj.g;regex+=obj.s;if(obj.g&&obj.c){code+=obj.c}}}}code+="if (y > 0 && z > 0){\nvar doyDate = new Date(y,0);\ndoyDate.setDate(z);\nm = doyDate.getMonth();\nd = doyDate.getDate();\n}";code+="if (y > 0 && m >= 0 && d > 0 && h >= 0 && i >= 0 && s >= 0)\n{return new Date(y, m, d, h, i, s);}\nelse if (y > 0 && m >= 0 && d > 0 && h >= 0 && i >= 0)\n{return new Date(y, m, d, h, i);}\nelse if (y > 0 && m >= 0 && d > 0 && h >= 0)\n{return new Date(y, m, d, h);}\nelse if (y > 0 && m >= 0 && d > 0)\n{return new Date(y, m, d);}\nelse if (y > 0 && m >= 0)\n{return new Date(y, m);}\nelse if (y > 0)\n{return new Date(y);}\n}return null;}";Date.parseRegexes[regexNum]=new RegExp("^"+regex+"$","i");eval(code)};Date.formatCodeToRegex=function(b,a){switch(b){case"D":return{g:0,c:null,s:"(?:Sun|Mon|Tue|Wed|Thu|Fri|Sat)"};case"j":case"d":return{g:1,c:"d = parseInt(results["+a+"], 10);\n",s:"(\\d{1,2})"};case"l":return{g:0,c:null,s:"(?:"+Date.dayNames.join("|")+")"};case"S":return{g:0,c:null,s:"(?:st|nd|rd|th)"};case"w":return{g:0,c:null,s:"\\d"};case"z":return{g:1,c:"z = parseInt(results["+a+"], 10);\n",s:"(\\d{1,3})"};case"W":return{g:0,c:null,s:"(?:\\d{2})"};case"F":return{g:1,c:"m = parseInt(Date.monthNumbers[results["+a+"].substring(0, 3)], 10);\n",s:"("+Date.monthNames.join("|")+")"};case"M":return{g:1,c:"m = parseInt(Date.monthNumbers[results["+a+"]], 10);\n",s:"(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)"};case"n":case"m":return{g:1,c:"m = parseInt(results["+a+"], 10) - 1;\n",s:"(\\d{1,2})"};case"t":return{g:0,c:null,s:"\\d{1,2}"};case"L":return{g:0,c:null,s:"(?:1|0)"};case"Y":return{g:1,c:"y = parseInt(results["+a+"], 10);\n",s:"(\\d{4})"};case"y":return{g:1,c:"var ty = parseInt(results["+a+"], 10);\ny = ty > Date.y2kYear ? 1900 + ty : 2000 + ty;\n",s:"(\\d{1,2})"};case"a":return{g:1,c:"if (results["+a+"] == 'am') {\nif (h == 12) { h = 0; }\n} else { if (h < 12) { h += 12; }}",s:"(am|pm)"};case"A":return{g:1,c:"if (results["+a+"] == 'AM') {\nif (h == 12) { h = 0; }\n} else { if (h < 12) { h += 12; }}",s:"(AM|PM)"};case"g":case"G":case"h":case"H":return{g:1,c:"h = parseInt(results["+a+"], 10);\n",s:"(\\d{1,2})"};case"i":return{g:1,c:"i = parseInt(results["+a+"], 10);\n",s:"(\\d{2})"};case"s":return{g:1,c:"s = parseInt(results["+a+"], 10);\n",s:"(\\d{2})"};case"O":return{g:0,c:null,s:"[+-]\\d{4}"};case"T":return{g:0,c:null,s:"[A-Z]{3}"};case"Z":return{g:0,c:null,s:"[+-]\\d{1,5}"};default:return{g:0,c:null,s:String.escape(b)}}};Date.prototype.getTimezone=function(){return this.toString().replace(/^.*? ([A-Z]{3}) [0-9]{4}.*$/,"$1").replace(/^.*?\(([A-Z])[a-z]+ ([A-Z])[a-z]+ ([A-Z])[a-z]+\)$/,"$1$2$3")};Date.prototype.getGMTOffset=function(){return(this.getTimezoneOffset()>0?"-":"+")+String.leftPad(Math.floor(Math.abs(this.getTimezoneOffset())/60),2,"0")+String.leftPad(Math.abs(this.getTimezoneOffset())%60,2,"0")};Date.prototype.getDayOfYear=function(){var a=0;Date.daysInMonth[1]=this.isLeapYear()?29:28;for(var b=0;b<this.getMonth();++b){a+=Date.daysInMonth[b]}return a+this.getDate()};Date.prototype.getWeekOfYear=function(){var b=this.getDayOfYear()+(4-this.getDay());var a=new Date(this.getFullYear(),0,1);var c=(7-a.getDay()+4);return String.leftPad(Math.ceil((b-c)/7)+1,2,"0")};Date.prototype.isLeapYear=function(){var a=this.getFullYear();return((a&3)==0&&(a%100||(a%400==0&&a)))};Date.prototype.getFirstDayOfMonth=function(){var a=(this.getDay()-(this.getDate()-1))%7;return(a<0)?(a+7):a};Date.prototype.getLastDayOfMonth=function(){var a=(this.getDay()+(Date.daysInMonth[this.getMonth()]-this.getDate()))%7;return(a<0)?(a+7):a};Date.prototype.getDaysInMonth=function(){Date.daysInMonth[1]=this.isLeapYear()?29:28;return Date.daysInMonth[this.getMonth()]};Date.prototype.getSuffix=function(){switch(this.getDate()){case 1:case 21:case 31:return"st";case 2:case 22:return"nd";case 3:case 23:return"rd";default:return"th"}};String.escape=function(a){return a.replace(/('|\\)/g,"\\$1")};String.leftPad=function(d,b,c){var a=new String(d);if(c==null){c=" "}while(a.length<b){a=c+a}return a};Date.daysInMonth=[31,28,31,30,31,30,31,31,30,31,30,31];Date.monthNames=["January","February","March","April","May","June","July","August","September","October","November","December"];Date.dayNames=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];Date.y2kYear=50;Date.monthNumbers={Jan:0,Feb:1,Mar:2,Apr:3,May:4,Jun:5,Jul:6,Aug:7,Sep:8,Oct:9,Nov:10,Dec:11};Date.patterns={ISO8601LongPattern:"Y-m-d H:i:s",ISO8601ShortPattern:"Y-m-d",ShortDatePattern:"n/j/Y",LongDatePattern:"l, F d, Y",FullDateTimePattern:"l, F d, Y g:i:s A",MonthDayPattern:"F d",ShortTimePattern:"g:i A",LongTimePattern:"g:i:s A",SortableDateTimePattern:"Y-m-d\\TH:i:s",UniversalSortableDateTimePattern:"Y-m-d H:i:sO",YearMonthPattern:"F, Y"}}());$(document).on("click",".show-hide-element",function(a){if($(this).data("show")!=undefined){$($(this).data("show")).removeClass("hidden")}if($(this).data("hide")!=undefined){$($(this).data("hide")).addClass("hidden")}});function show_loading(a){$(a).html($("#loader").html())}function CKupdate(){if(typeof CKEDITOR!="undefined"){for(instance in CKEDITOR.instances){CKEDITOR.instances[instance].updateElement()}}}function show_miniloading(a){if(a.is("button")){a.attr("disabled","disabled");if(a.find(".mini-loader-image").length==0){a.append($("#mini-loader").html())}}else{if(a.is("form")){a.find(":submit").attr("disabled","disabled");if(a.find(":submit").find(".mini-loader-image").length==0){a.find(":submit").append($("#mini-loader").html())}}else{if(a.is("a")){a.attr("disabled","disabled");if(a.find(".mini-loader-image").length==0){a.append($("#mini-loader").html())}}}}}function hide_miniloading(a){if(a.is("button")){a.removeAttr("disabled");a.find("img").remove()}else{if(a.is("form")){a.find(":submit").removeAttr("disabled");a.find(":submit").find("img").remove()}else{if(a.is("a")){a.removeAttr("disabled");a.find("img").remove()}}}$(".file-upload-message").remove()}function datatable(){var a=$("#sample_1").dataTable({aoColumnDefs:[{aTargets:[0]}],oLanguage:{sLengthMenu:"",sSearch:"",oPaginate:{sPrevious:"",sNext:""}},aaSorting:[[1,"asc"]],aLengthMenu:[[5,10,15,20,-1],[5,10,15,20,"All"]],iDisplayLength:10});$("#sample_1_wrapper .dataTables_filter input").addClass("form-control input-sm").attr("placeholder","Search");$("#sample_1_wrapper .dataTables_length select").addClass("m-wrap small")}$(document).ready(function(){if($(".measure-text-length").size()>=1){$(".measure-text-length").each(function(){a($(this))})}$(document).on("keyup",".measure-text-length",function(){a($(this))});function a(e){var c=e.data("limit");var b=e.data("html");var d=e.val();if(c!=undefined&&b!=undefined&&d!=undefined){$(b).html(d.length+"/"+c)}}$(document).ready(function(){$('[data-toggle="tooltip"]').tooltip()});$(document).on("click",".copy-link",function(c){var d=$(this);var b=document.createElement("textarea");b.value=d.data("content");b.setAttribute("readonly","");b.style.position="absolute";b.style.left="-9999px";document.body.appendChild(b);b.select();document.execCommand("copy");document.body.removeChild(b);d.addClass("animated bounce");setTimeout(function(){d.removeClass("animated bounce")},2000);alert("Link Copied Successfully!")});$(".datepicker").each(function(b,c){$(this).datetimepicker({timepicker:false,format:"d-m-Y",minDate:$(this).data("mindate"),maxDate:$(this).data("maxdate"),startDate:$(this).data("startdate")})});$(".ckeditor").each(function(b,c){CKEDITOR.replace(this,{customConfig:$(this).data("customconfig"),height:$(this).attr("height")!=undefined?$(this).attr("height"):250,allowedContent:true});$(this).removeClass("ckeditor")});if($(".popovers").length){$(".popovers").popover()}$(document).on("submit","#generate-society-letters",function(c){CKupdate();c.preventDefault();var b=$(this);b.find(".custom-error").html("");show_miniloading(b);$.ajax({url:b.attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(d){hide_miniloading(b);if(d.error==true){$.each(d.display_errors,function(f,e){$.each(d.display_errors,function(h,g){$("#"+h).html(g)})})}else{window.location.href=d.link}}})});$(document).on("submit","form",function(b){if($(this).attr("enctype")){if($(this).find(".file-upload-message").hasClass("file-upload-message")==false){$(this).find("button[type=submit]").after('<div class="file-upload-message">Have patience! Submission will take time due to file upload. Please wait.</div>')}}});$(document).on("submit",".form-submission-multipart",function(c){CKupdate();c.preventDefault();var b=$(this);b.find(".custom-error").html("");show_miniloading(b);$.ajax({url:b.attr("action"),data:new FormData(this),contentType:false,cache:false,processData:false,dataType:"json",type:"post",success:function(d){hide_miniloading(b);if(d.error==true){$.each(d.display_errors,function(f,e){$.each(d.display_errors,function(h,g){$("#"+h).html(g)})})}else{window.location.href=d.link}}})});$(document).on("submit","#tech-support-form",function(c){c.preventDefault();var b=$(this);$(".custom-error").removeClass("hidden");show_miniloading(b);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(d){hide_miniloading(b);if(d.error==true){$.each(d.display_errors,function(f,e){$("#tech-support-form #"+f).html(e)})}else{$("#tech-support-form")[0].reset();$(".custom-error").addClass("hidden");$(".bs-example-modal-sm").click()}}})});$(document).on("submit","#customer-support-form",function(b){this_form=$(this);b.preventDefault();$(".custom-error").removeClass("hidden");show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{$("#customer-support-form")[0].reset();$(".custom-error").addClass("hidden");$(".bs-example-modal-sm").click()}}})});$(document).on("submit","#contact-us-form",function(b){this_form=$(this);b.preventDefault();$(".custom-error").removeClass("hidden");show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{$("#contact-us-form")[0].reset();$(".custom-error").addClass("hidden");$(".bs-example-modal-sm").click();$("body").append('<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/940278076/?label=amCTCK267mUQvIKuwAM&amp;guid=ON&amp;script=0"/>')}}})});$(document).on("submit","#feedback-form",function(b){this_form=$(this);b.preventDefault();$(".custom-error").removeClass("hidden");show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{$("#feedback-form")[0].reset();$(".custom-error").addClass("hidden");$(".bs-example-modal-sm").click()}}})});$(document).on("submit","#login-form",function(b){b.preventDefault();this_form=$(this);show_miniloading(this_form);this_form.find(".custom-error").html("");$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{window.location.assign(c.redirect_url)}}})});$(document).on("click",".show-contact-us-form",function(b){b.preventDefault();$("#contact-us-popup-model").modal()});$(document).on("submit","#contact-us-popup-form",function(b){this_form=$(this);b.preventDefault();show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{console.log($("#contact-us-popup-form").find(".success-message"));$("#contact-us-popup-form").find(".success-message").html(c.p_text);$("#contact-us-popup-form").find(".form-success").removeClass("hidden");$("#contact-us-popup-form").find(".custom-error").addClass("hidden");$("#contact-us-popup-form")[0].reset();$("body").append('<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/940278076/?label=amCTCK267mUQvIKuwAM&amp;guid=ON&amp;script=0"/>')}}})});$(document).on("click",".show-society-register-form",function(b){b.preventDefault();console.log($(this).data("register-form"));if($(this).data("register-form")!=undefined){$("form#submit-society-register-form").find('input[name="request-from"]').val($(this).data("register-form"))}if($(this).data("demo-request")=="1"){$("#lead-demo-request").val("1")}$("#enquiry-popup-model").modal()});$(document).on("submit","#submit-society-register-form",function(b){this_form=$(this);b.preventDefault();show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{$("#submit-society-register-form")[0].reset();$("#submit-society-register-form").find(".success-message").html(c.p_text);$("#submit-society-register-form").find(".form-success").removeClass("hidden");$("#submit-society-register-form").find(".custom-error").addClass("hidden");if(c.redirect_url!=undefined){window.location.href=c.redirect_url}}}})});$(document).on("submit","#submit-gate-register-form",function(b){this_form=$(this);b.preventDefault();show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{$("#submit-gate-register-form")[0].reset();$("#submit-gate-register-form").find(".success-message").html(c.p_text);$("#ssubmit-gate-register-form").find(".form-success").removeClass("hidden");$("#submit-gate-register-form").find(".custom-error").addClass("hidden");$("#myModal").modal("hide");if(c.redirect_url!=undefined){window.location.href=c.redirect_url}}}})});$(document).on("click",".get-a-quote",function(b){b.preventDefault();this_form=$(this);console.log(this_form);show_miniloading(this_form);$.ajax({url:BASE_URL+"activity/get_a_guote",type:"post",data:[{name:"plan-name",value:$(this).data("plan")},{name:"plan-id",value:$(this).data("plan-id")}],success:function(c){hide_miniloading(this_form);$("#my-modal-content").html(c);$("#my-modal").modal()}})});$(document).on("submit","#submit-get-a-guote",function(b){this_form=$(this);b.preventDefault();show_miniloading(this_form);$.ajax({url:$(this).attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(c){hide_miniloading(this_form);if(c.error==true){$.each(c.display_errors,function(e,d){this_form.find("#"+e).html(d)})}else{$("#submit-get-a-guote")[0].reset();$(".success-message").html(c.p_text);$(".form-success").removeClass("hidden");$(".custom-error").addClass("hidden");$("body").append('<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/940278076/?label=amCTCK267mUQvIKuwAM&amp;guid=ON&amp;script=0"/>')}}})});$(document).on("click",".get-a-soc-accounting-quote",function(b){b.preventDefault();this_form=$(this);show_miniloading(this_form);$.ajax({url:BASE_URL+"activity/get_a_soc_accouting_guote",type:"post",data:[{name:"plan-name",value:$(this).data("plan")},{name:"plan-id",value:$(this).data("plan-id")}],success:function(c){hide_miniloading(this_form);$("#my-modal-content").html(c);$("#my-modal").modal()}})});$(document).on("click",".ms-play-video",function(c){c.preventDefault();$(this).closest(".ms-video-description").addClass("hidden");var b=$(this).closest(".ms-video").find("video").first();b.attr("controls","controls");console.log(b);b.removeClass("opacityp3");b.get(0).play();ga("send","event","Maintenance Free Register","demo video")});$(document).on("click",".track-google-event",function(b){b.preventDefault();ga("send","event",$(this).data("t1"),$(this).data("t2"))})});
/*!
 * Select2 4.0.6-rc.1
 ...
 */
(function(e){if(typeof d.define==="function"&&d.define.amd){d.define("jquery-mousewheel",["jquery"],e)}else{if(typeof exports==="object"){module.exports=e}else{e(c)}}}(function(g){var h=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],o=("onwheel" in document||document.documentMode>=9)?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],m=Array.prototype.slice,n,f;if(g.event.fixHooks){for(var j=h.length;j;){g.event.fixHooks[h[--j]]=g.event.mouseHooks}}var k=g.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener){for(var q=o.length;q;){this.addEventListener(o[--q],p,false)}}else{this.onmousewheel=p}g.data(this,"mousewheel-line-height",k.getLineHeight(this));g.data(this,"mousewheel-page-height",k.getPageHeight(this))},teardown:function(){if(this.removeEventListener){for(var q=o.length;q;){this.removeEventListener(o[--q],p,false)}}else{this.onmousewheel=null}g.removeData(this,"mousewheel-line-height");g.removeData(this,"mousewheel-page-height")},getLineHeight:function(q){var i=g(q),r=i["offsetParent" in g.fn?"offsetParent":"parent"]();if(!r.length){r=g("body")}return parseInt(r.css("fontSize"),10)||parseInt(i.css("fontSize"),10)||16},getPageHeight:function(i){return g(i).height()},settings:{adjustOldDeltas:true,normalizeOffset:true}};g.fn.extend({mousewheel:function(i){return i?this.bind("mousewheel",i):this.trigger("mousewheel")},unmousewheel:function(i){return this.unbind("mousewheel",i)}});function p(i){var s=i||window.event,y=m.call(arguments,1),A=0,u=0,t=0,x=0,w=0,v=0;i=g.event.fix(s);i.type="mousewheel";if("detail" in s){t=s.detail*-1}if("wheelDelta" in s){t=s.wheelDelta}if("wheelDeltaY" in s){t=s.wheelDeltaY}if("wheelDeltaX" in s){u=s.wheelDeltaX*-1}if("axis" in s&&s.axis===s.HORIZONTAL_AXIS){u=t*-1;t=0}A=t===0?u:t;if("deltaY" in s){t=s.deltaY*-1;A=t}if("deltaX" in s){u=s.deltaX;if(t===0){A=u*-1}}if(t===0&&u===0){return}if(s.deltaMode===1){var z=g.data(this,"mousewheel-line-height");A*=z;t*=z;u*=z}else{if(s.deltaMode===2){var r=g.data(this,"mousewheel-page-height");A*=r;t*=r;u*=r}}x=Math.max(Math.abs(t),Math.abs(u));if(!f||x<f){f=x;if(e(s,x)){f/=40}}if(e(s,x)){A/=40;u/=40;t/=40}A=Math[A>=1?"floor":"ceil"](A/f);u=Math[u>=1?"floor":"ceil"](u/f);t=Math[t>=1?"floor":"ceil"](t/f);if(k.settings.normalizeOffset&&this.getBoundingClientRect){var q=this.getBoundingClientRect();w=i.clientX-q.left;v=i.clientY-q.top}i.deltaX=u;i.deltaY=t;i.deltaFactor=f;i.offsetX=w;i.offsetY=v;i.deltaMode=0;y.unshift(i,A,u,t);if(n){clearTimeout(n)}n=setTimeout(l,200);return(g.event.dispatch||g.event.handle).apply(this,y)}function l(){f=null}function e(q,i){return k.settings.adjustOldDeltas&&q.type==="mousewheel"&&i%120===0}}));d.define("jquery.select2",["jquery","jquery-mousewheel","./select2/core","./select2/defaults","./select2/utils"],function(i,g,e,j,h){if(i.fn.select2==null){var f=["open","close","destroy"];i.fn.select2=function(m){m=m||{};if(typeof m==="object"){this.each(function(){var o=i.extend(true,{},m);var n=new e(i(this),o)});return this}else{if(typeof m==="string"){var l;var k=Array.prototype.slice.call(arguments,1);this.each(function(){var n=h.GetData(this,"select2");if(n==null&&window.console&&console.error){console.error("The select2('"+m+"') method was called on an element that is not using Select2.")}l=n[m].apply(n,k)});if(i.inArray(m,f)>-1){return this}return l}else{throw new Error("Invalid arguments for Select2: "+m)}}}}if(i.fn.select2.defaults==null){i.fn.select2.defaults=j}return e});return{define:d.define,require:d.require}}());var a=b.require("jquery.select2");c.fn.select2.amd=b;return a}));function cycleImages(){$(".cycler").each(function(b,c){var a=$("#"+$(c).attr("id")+".cycler div.active");a.fadeOut(1500,function(){var d=(a.next().length>0)?a.next():$("#"+$(c).attr("id")+".cycler div:first");d.css("z-index",2);a.css("z-index",1).show().removeClass("active");d.css("z-index",3).addClass("active")})});setTimeout(function(){cycleImages()},5000)}function getVendorChildCategory(c,b,a){$(".child_category_list").parent("div").find("small").html("Please wait...");$.ajax({url:BASE_URL+"vendors_submenu/"+c,type:"get",success:function(d){$(".child_category_list").parent("div").find("small").html(b);$(".child_category_list").html(d);if(a==1){$("html, body").animate({scrollTop:$("#vendor-category-list").offset().top},1000);$("#vendor-category-animation").slideUp("slow");$("#vendor-category-animation").slideDown("slow")}}})}function show_miniloading(a){if(a.is("button")){a.attr("disabled","disabled");if(a.find(".mini-loader-image").length==0){a.append($("#mini-loader").html())}}else{if(a.is("form")){a.find(":submit").attr("disabled","disabled");if(a.find(":submit").find(".mini-loader-image").length==0){a.find(":submit").append($("#mini-loader").html())}}else{if(a.is("a")){a.attr("disabled","disabled");if(a.find(".mini-loader-image").length==0){a.append($("#mini-loader").html())}}}}}function hide_miniloading(a){if(a.is("button")){a.removeAttr("disabled");a.find("img").remove()}else{if(a.is("form")){a.find(":submit").removeAttr("disabled");a.find(":submit").find("img").remove()}else{if(a.is("a")){a.removeAttr("disabled");a.find("img").remove()}}}$(".file-upload-message").remove()}function selectSearch(a){$("input[name='vendor-search']").val(a);$("#suggesstion-box").hide();$("form").submit()}function selectSearchCity(a){$("input[name='city']").val(a);$("#city-suggesstion-box").hide();$("form").submit()}function showPosition(a){setCookie("latitude",a.coords.latitude);setCookie("longitude",a.coords.longitude)}function setCookie(b,c){var a=new Date();a.setTime(a.getTime()+300000);document.cookie=b+"="+c+";expires="+a.toUTCString()}function getCookie(a){var b=document.cookie.match("(^|;) ?"+a+"=([^;]*)(;|$)");return b?b[2]:null}$(document).ready(function(){setTimeout(function(){cycleImages()},5000)});function focusWord(f){var g=f.getSelection();var d=g.getStartElement();var b=f.getSelection().getRanges()[0];var c=b.startContainer;if(c.type==CKEDITOR.NODE_TEXT&&b.startOffset){var h=c.getText();var e=h.lastIndexOf("{",b.startOffset)+1;var a=h.indexOf("}",b.startOffset);if(e!=0&&a!=-1){b.setStart(d.getFirst(),e-1);b.setEnd(d.getFirst(),a+1);g.selectRanges([b])}}}$(document).ready(function(){$(window).load(function(){if($("#site-header").hasClass("fixed")){var a=window.location.hash.substr(1);if((a!=""||a!=undefined)&&$("#"+a).length==1){var b=$("#"+a).offset().top;document.documentElement.scrollTop=document.body.scrollTop=b-($("#site-header").height()+30)}}})});$(document).ready(function(){$("#add-more-bank-points").click(function(f){f.preventDefault();$("#generate-letter-extra-pts").append($("#generate-letter-extra-pts-content").html())});$(document).on("click",".generate-letter-remove-extra-pt",function(f){f.preventDefault();$(this).closest(".generate-letter-extra-pts-entity").remove()});$(document).on("click","#generate-letter-add-more-nominee",function(g){g.preventDefault();var f=$("#nominee-content").find(".generate-letter-nominee-relationship").last();highest_attr=f.attr("name");console.log(highest_attr);higher_num=highest_attr.substring(highest_attr.lastIndexOf("[")+1,highest_attr.lastIndexOf("]"));higher_num=parseInt(higher_num)+1;console.log(higher_num);$("#nominee-content").append($("#nominee-template").html());$("#nominee-content").find(".nominee-entity").last().find(":input").each(function(h,j){this.name=(this.name).substr(0,(this.name).lastIndexOf("["))+"["+higher_num+"]";console.log("1")})});$(document).on("click",".generate-letter-remove-nominee",function(f){f.preventDefault();$(this).closest(".nominee-entity").remove()});if($("#generate-letter-content").length>=1){CKEDITOR.instances["generate-letter-content"].on("contentDom",function(){this.document.on("click",function(e){focusWord(CKEDITOR.instances["generate-letter-content"])})})}$(document).on("click",".vendor-parent-category",function(h){h.preventDefault();var g=$(this).data("parent-id");var f=$(this).data("parent-name");getVendorChildCategory(g,f,1)});if($("a").hasClass("vendor-parent-category")){var c=$(".vendor-parent-category").first().data("parent-id");var b=$(".vendor-parent-category").first().data("parent-name");getVendorChildCategory(c,b,0)}$(document).on("submit","#zsociety-register-form",function(g){g.preventDefault();var f=$(this);show_miniloading(f);$(".custom-error").html("");$.ajax({url:f.attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(e){hide_miniloading(f);if(e.error==true){$.each(e.display_errors,function(i,h){console.log(i);console.log(h);$("#"+i).html(h)})}else{$(".success-message").html(e.success);$(".form-success").removeClass("hidden");$("#zsociety-register-form")[0].reset();if(e.redirect_url!=undefined){window.location.href=e.redirect_url}}}})});$(document).on("submit","#zsociety-maintenance-payment-form",function(g){g.preventDefault();var f=$(this);show_miniloading(f);$(".custom-error").html("");$.ajax({url:f.attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(e){hide_miniloading(f);if(e.error==true){$.each(e.display_errors,function(i,h){$("#"+i).html(h)})}else{if(e.redirect_url!=undefined){window.location.href=e.redirect_url}}}})});$(document).on("submit","#business-listing-form",function(g){g.preventDefault();var f=$(this);show_miniloading(f);$.ajax({url:BASE_URL+"business-list/register",data:$(this).serialize(),dataType:"json",type:"post",success:function(e){hide_miniloading(f);if(e.error==true){$.each(e.display_errors,function(i,h){$("#"+i).html(h)})}else{$(".contact-form").html(e.success)}}})});$(document).on("click","#mys_businessbtn",function(f){f.preventDefault();if($(".mys_addbusines").hasClass("hidden")){$(this).html("Remove");$('input[name="more_business"]').attr("checked","");$(".mys_addbusines").removeClass("hidden");$(".mys_addbusines").show()}else{$(this).html("Add More Business");$('input[name="more_business"]').removeAttr("checked");$(".mys_addbusines").addClass("hidden");$(".mys_addbusines").hide()}});$(document).on("change",'select[name="business-category-name-1"]',function(h){h.preventDefault();var f=$(this).val();var g={category_id:f};$.ajax({url:BASE_URL+"business-list/business_sub_category",data:g,type:"get",success:function(e){html1="<option value=''>Select</option>";htmlcat=jQuery.parseJSON(e);$.each(htmlcat.category,function(i,j){html1+="<option value="+j.id+">"+j.category_name+"</option>"});$("#business-sub-category-name-1").html(html1)}})});$(document).on("change",'select[name="business-category-name-2"]',function(h){h.preventDefault();var f=$(this).val();var g={category_id:f};$.ajax({url:BASE_URL+"business-list/business_sub_category",data:g,type:"get",success:function(e){html1="<option value=''>Select</option>";htmlcat=jQuery.parseJSON(e);$.each(htmlcat.category,function(i,j){html1+="<option value="+j.id+">"+j.category_name+"</option>"});$("#business-sub-category-name-2").html(html1)}})});$(document).on("change",'select[name="business-state-1"]',function(h){h.preventDefault();var f=$(this).val();var g={state_id:f};$.ajax({url:BASE_URL+"business-list/business_city",data:g,type:"get",dataType:"json",success:function(e){html1="<option value=''>Select</option>";$.each(e.city_list,function(i,j){html1+="<option value="+j.id+">"+j.city_name+"</option>"});$("#business-city-1").html(html1)}})});$(document).on("change",'select[name="business-state-2"]',function(h){h.preventDefault();var f=$(this).val();var g={state_id:f};$.ajax({url:BASE_URL+"business-list/business_city",data:g,type:"get",dataType:"json",success:function(e){html1="<option value=''>Select</option>";$.each(e.city_list,function(i,j){html1+="<option value="+j.id+">"+j.city_name+"</option>"});$("#business-city-2").html(html1)}})});$(document).on("submit","#advertisement-form",function(g){g.preventDefault();var f=$(this);show_miniloading(f);$.ajax({url:BASE_URL+"advertisement/proccess_advertisement",data:$(this).serialize(),dataType:"json",type:"post",success:function(e){hide_miniloading(f);if(e.error==true){$.each(e.display_errors,function(i,h){$("#"+i).html(h)})}else{$(".advertisement-form").html(e.success)}}})});$(document).on("click",".select-plan",function(g){g.preventDefault();var f=$(this).data("plan-id");$('input[name="plan-id"]').val(f);$(".legal-membership-form").removeClass("hidden");$("html, body ").animate({scrollTop:$("div.legal-membership-form").offset().top},1000)});$(document).on("click","#legal-assistance-tearm-condition-modal-sm",function(f){f.preventDefault();$(".legal-assistance-tearm-condition-modal-sm").modal()});$(document).on("submit","#submit-legal-advisee-form",function(f){this_form=$(this);f.preventDefault();show_miniloading(this_form);$.ajax({url:BASE_URL+"activity/submit_legal_advisee_form",data:$(this).serialize(),dataType:"json",type:"post",success:function(e){hide_miniloading(this_form);$(".custom-error").html("");if(e.error==true){$.each(e.display_errors,function(h,g){this_form.find("#"+h).html(g)})}else{if(e.redirect_url!=undefined){window.location=e.redirect_url}else{$("#submit-legal-advisee-form").addClass("hidden");$(".success-message").html(e.p_text);$(".form-success").removeClass("hidden");$(".custom-error").html("")}}}})});var a;$(document).on("keyup","input[name='vendor-search']",function(i){var h=3;var g=$("input[name='vendor-search']").val();var f=i.which;console.log(f);if(f==20||f==16||f==9||f==27||f==17||f==91||f==19||f==18||f==93||(f>=35&&f<=40)||f==45||(f>=33&&f<=34)||(f>=112&&f<=123)||(f>=144&&f<=145)){console.log(f);return false}if(g.length>=h){if(a&&a.readystate!=4){a.abort()}a=$.ajax({type:"POST",url:BASE_URL+"vendors/autocomplete",data:[{name:"keyword",value:$(this).val()},{name:"city",value:$('input[name="city"]').val()},{name:"parent-category",value:$('input[name="parent-category"]').val()},{name:"child-category",value:$('input[name="child-category"]').val()}],beforeSend:function(){$("input[name='vendor-search']").css("background","#FFF url(assets/images/wait.gif) no-repeat 165px")},success:function(e){$("input[name='vendor-search']").css("background","");$("#suggesstion-box").show();$("#suggesstion-box").html(e);$("#search-box").css("background","#FFF");$(".list-group").blur()}})}else{if(g.length>=0){$("#suggesstion-box").html("")}}});$(document).on("keydown",'input[name="vendor-search"]',function(g){var f=g.which;if(f==38||f==40||f==13){if(f==40){if($("#search-vendor-form").find("div.list-group a.arrow-select.arrow-selected").length==0){$("#search-vendor-form").find("div.list-group a.arrow-select:first").addClass("arrow-selected")}else{$("#search-vendor-form").find("div.list-group a.arrow-select.arrow-selected").removeClass("arrow-selected").next().addClass("arrow-selected")}}else{if(f==38){if($("#search-vendor-form").find("div.list-group a.arrow-select.arrow-selected").length==0){$("#search-vendor-form").find("div.list-group a.arrow-select:first").addClass("arrow-selected")}else{$("#search-vendor-form").find("div.list-group a.arrow-select.arrow-selected").removeClass("arrow-selected").prev().addClass("arrow-selected")}}}if(f==13){if($("#search-vendor-form").find("div.list-group a.arrow-select.arrow-selected").length>0){window.location.href=$("#search-vendor-form").find("div.list-group a.arrow-select.arrow-selected").attr("href")}else{$("#search-vendor-form").submit()}}return false}});var d;$(document).on("keyup","input[name='city']",function(i){var g=$("input[name='city']").val();var h=2;if(g.length>=h){var f=i.which;if(f==20||f==16||f==9||f==27||f==17||f==91||f==19||f==18||f==93||(f>=35&&f<=40)||f==45||(f>=33&&f<=34)||(f>=112&&f<=123)||(f>=144&&f<=145)){return false}if(d&&d.readystate!=4){d.abort()}d=$.ajax({type:"POST",url:BASE_URL+"city/autocomplete",data:"keyword="+$(this).val(),dataType:"json",beforeSend:function(){$("input[name='city']").css("background","#FFF url(assets/images/wait.gif) no-repeat 165px")},success:function(e){if(e.search==true){$("datalist#city-suggesstion-box").html("");$.each(e.city,function(k,j){$("datalist#city-suggesstion-box").append('<option value="'+j+'"></option>')})}}})}});setTimeout(function(){maintain_initial_static_page()},1000);$(document).on("submit","#get-best-deal-on-business",function(g){g.preventDefault();var f=$(this);show_miniloading(f);f.find(".custom-error").html("");$.ajax({url:f.attr("action"),data:f.serialize(),type:"post",dataType:"json",success:function(e){hide_miniloading(f);if(e.error==true){$.each(e.display_errors,function(i,h){$("#"+i).html(h)})}else{$("message").html(e.p_text);$("#get-best-deal-on-business")[0].reset();$(".success-message-modal-sm").modal();$(".get-best-deal-modal-sm").modal("hide")}}})});$(document).on("blur",".change-content",function(i){var j=$("#"+$(this).data("change-content")).val();$("#copy-letter-content").html(j);var f=$(this).val();var h=$(this).data("replace");$("."+h).replaceWith(f);var g=$("#copy-letter-content").html();CKEDITOR.instances[$(this).data("change-content")].setData(g);CKupdate()});$(document).on("change","input[name=zsociety-flat-no]",function(){var g=$("select[name=zsociety-name] option:selected").val();var e=$(this).val();var f={"zsociety-id":g,"flat-no":e};$.ajax({url:BASE_URL+"/maintenance-billing/pay_online/get_member_detail",data:f,type:"GET",dataType:"json",success:function(h){$("form#zsociety-maintenance-payment-form").find(".custom-error").html("");if(h.error==true){if(h.display_errors!=undefined){$.each(h.display_errors,function(j,i){$("form#zsociety-maintenance-payment-form").find("#"+j).html(i)})}if(h.p_text!=undefined){new PNotify({title:h.p_title,text:h.p_text,type:h.p_type})}$("#zsociety-property-detail").addClass("hidden");$("label#member-name").html("");$("label#email-address").html("");$("label#mobile").html("")}else{$("#zsociety-property-detail").removeClass("hidden");$("label#member-name").html(h.property_detail.member_name);$("label#email-address").html(h.property_detail.email);$("label#mobile").html(h.property_detail.mobile);$("input[name=zsociety-maintenance-payment-email]").val(h.property_detail.email);$("input[name=zsociety-maintenance-mobile]").val(h.property_detail.mobile);if(h.property_detail.email!=""){$("input[name=zsociety-maintenance-payment-email]").attr("disabled","true")}if(h.property_detail.mobile!=""){$("input[name=zsociety-maintenance-mobile]").attr("disabled","true")}}},error:function(h){alert("failed")}})});$(document).on("submit","#award-register",function(g){g.preventDefault();var f=$(this);$.ajax({url:f.attr("action"),data:$(this).serialize(),dataType:"json",type:"post",success:function(e){hide_miniloading(f);if(e.error==true){new PNotify({title:e.p_title,text:e.p_text,type:e.p_type})}else{if(e.redirect!=undefined){redirect(e.redirect)}else{if(e.redirect_url!=undefined){window.location.href=e.redirect_url}}}}})})});function formatData(a){if(a.loading){return a.search_name}markup="<li>"+a.search_name+"</li>";return markup}function formatDataSelection(a){return"Searching here.."}function maintain_initial_static_page(){var b=window.location.href;var a=window.location.pathname.split("/");if(a.length>=4){setTimeout(function(){if($(document).find("get-best-deal-modal-sm")){$(".get-best-deal-modal-sm").modal()}},1000)}if(isNaN(getCookie("latitude"))||getCookie("latitude")==null){}};